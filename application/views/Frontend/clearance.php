<?php
include 'assets/Frontend/inc/config.php';
...
<!-- <iframe src="<?php echo base_url('ClearanceForm/index_content') ?>" style="zoom:0; height: 100%; width: 100%; margin-left: 0%;" scrolling="no" frameborder="0"></iframe> -->
        ...
        <div class="row">
            ...
            <div class="tab-content">
                <div id="step1" class="tab-pane fade in active">
                    <form action="javascript:void(0)" onsubmit="activaTab('step2')" data-toggle="tab disable" data-target="#step2" id="clearanceForm" class="form-horizontal form-control-borderless">
                        ...
                        <div class="col-sm-12 col-md-8 col-lg-8">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="yearPresentAddress" id="yearPresentAddress" placeholder="No. of Years in Present Address" class="form-control"></input>
                                        <!-- <label class="help-block"></label> -->
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div style="margin-bottom: 10%;">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-2 col-lg-2" id="clearanceBtnForm">
                                            <button type="submit" id="btnNext" class="btn btn-primary btn-effect.ripple">Next</button>
                                        </div>
                                        <div class="col-sm-0 col-md-4 col-lg-4"></div>
                                    </div>
                                </div>
