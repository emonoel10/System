    ...
    <div class="row" id="map-container">
        ...
        <div id="gmap-satellite" class="col-sm-12 gmap">
            <div class="row" id="searchBoxContent">
                <div class="col-sm-10 col-md-7 col-lg-10 text-center">
            ...
            <!-- <div id="map" style="margin-left: -5%;"> -->
            <?php echo $map['html']; ?>
            <!-- </div> -->
        </div>
        ...
        <div class="col-sm-12" id="print">
            <button type="button" id="print" onclick="window.print();" class="btn btn-effect-ripple btn-info text-center" style="overflow: hidden; position: relative; float: center;"><i class="fa fa-print"></i> Print</button>
        </div>
    </div>
</section>
