                                ...
                                <div class="form-body">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input name="bday" id="bday" placeholder="MM/DD/YYYY" onchange="ageCount()" class="form-control bday-datepicker">
...
$(document).ready(function() {
    ...
    table = $('#table').dataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('InfoTable2/ajax_list') ?>",
            "type": "POST"
        },
...
function edit_resident(id) {
    ...
    $.ajax({
        url: "<?php echo site_url('InfoTable2/ajax_edit/') ?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function save() {
    ...
    if (save_method == 'add') {
        url = "<?php echo site_url('InfoTable2/ajax_add') ?>";
    } else {
        url = "<?php echo site_url('InfoTable2/ajax_update') ?>";
    }
...
function delete_resident(id) {
    if (confirm('Are you sure delete this data?')) {
        ...
        $.ajax({
            url: "<?php echo site_url('InfoTable2/ajax_delete') ?>/" + id,
            type: "POST",
            dataType: "JSON",
            success: function(data) {
