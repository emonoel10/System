...
<div id="page-content">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="block full">
                <div>
                    <canvas id="totalPopulationByPurok" class="center-block" style="height: 100%; width: 100%;"></canvas>
                </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="block full">
                <canvas id="ageRangesPieMale" class="center-block" style="height: 100%; width: 100%;"></canvas>
                <br><br>
        ...
        <div class="col-sm-12">
            <div class="block full">
                <canvas id="ageRangesPieFemale" class="center-block" style="height: 100%; width: 100%;"></canvas> 
                <br><br>
