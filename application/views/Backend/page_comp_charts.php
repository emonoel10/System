...
<div id="page-content">
        ...
        <div class="col-sm-12">
            <div class="block full">
                <div class="block-title">
                    <h2>Population of Brgy. Cagangohan by Purok in Bar Graph</h2>
                </div>
                <canvas id="totalPopulationByPurok" style="height: 100%; width: 100%;"></canvas>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="block full"> 
                <div class="block-title">
                    <h2>Age Range Pie Chart (Male)</h2>
                </div>
                <canvas id="ageRangesPieMale" style="height: 100%; width: 100%;"></canvas> 
            </div>
        </div>
        <div class="col-sm-6">
            <div class="block full"> 
                <div class="block-title">
                    <h2>Age Range Pie Chart (Female)</h2>
                </div>
                <canvas id="ageRangesPieFemale" style="height: 100%; width: 100%;"></canvas> 
            </div>
        </div>
    </div>
