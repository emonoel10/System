<div id="sidebar">
    <div id="sidebar-brand" class="themed-background">
        <a class="sidebar-title btn-effect-ripple" style="cursor: default;">
            <i><img src="<?=base_url();?>assets/Backend/images/CagangohanPics/brgyCagangohan180.png" style="width: 60px; height: 40px; margin-left: -19px;"/></i> <span class="sidebar-nav-mini-hide animation-fadeIn" style="font-size: 13px;">Brgy.Cagangohan <strong>GIS</strong></span>
        </a>
    </div>
