...
<div id="sidebar">
    ...
    <div id="sidebar-brand" class="themed-background">
        <a class="sidebar-title btn-effect-ripple" style="cursor: default;">
            <i><img src="<?=base_url();?>assets/Backend/images/Ph_seal_davao_del_norte_panabo_city.png" style="width: 30px; height: 30px; margin-left: -5px;"/></i> <span class="sidebar-nav-mini-hide animation-fadeIn" style="font-size: 13px;">Brgy.Cagangohan <strong>GIS</strong></span>
        </a>
    </div>
    <!-- END Sidebar Brand -->
