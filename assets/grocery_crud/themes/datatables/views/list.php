<table cellpadding="0" cellspacing="0" border="0" class="display groceryCrudTable table table-striped table-borderless table-vcenter table-hover table-condensed table-responsive table-featured" id="<?php echo uniqid(); ?>" style="height: 50px">
	<thead>
		<tr>
	...
	<tbody>
		...
		<tr id='row-<?php echo $num_row?>'>
			...
			<td class='actions'>
				...
				?>
						<a href="<?php echo $action_url; ?>" class="edit_button btn btn-small btn-effect-ripple btn-ripple btn-default" role="button">
